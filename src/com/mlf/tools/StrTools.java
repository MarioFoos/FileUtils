 ...
 * Las funciones de conversi�n siguen los nombres:
...
public class StrTools
{
	...
	/**
	 * Valor num�rico a cadena que lo representa (p.e. 123 -> "123")
	 ...
	 * @return Cadena que representa el valor num�rico
	 */
	...
	/**
	 * Valor num�rico a cadena hexa que lo representa 1234 (= 4D2) -> "4D2"
	 * @param value Valor entero
	 * @param len Longitud de la cadena de salida, se rellena con ceros a la izquierda o se recorta para ajustar
	 * @return Cadena hexadecimal que representa el valor num�rico
	 */
	...
	/**
	 * Convertir un n�mero a buffer BCD 12345 -> [01 23 45]
	 * @param value N�mero
	 * @param digits D�gitos del n�mero BCD
	...
	/**
	 * Determinal si un caracter es un d�gito hexadecimal ('1'...'9', 'A'/'a'...'F'/'f')
	 * @param car Caracter
	 * @return true/false
	 */
	...
	/**
	 * Convertir un d�gito hexadecimal (0 a 15) en un caracter representativo
	 * @param digit D�gito hexadecimal
	 * @return Caracter
	 */
	...
	/**
	 * Pasar un n�mero a un array de byte 5874 (= 0x16F2) -> [00 00 16 F2] (len = 4)
	 * @param value N�mero
	 * @param len Longitud en bytes del buffer de salida
	 * @return Buffer con el n�mero
	 */
	...
	/**
	 * Ajustar una cadena de n�meros al largo dado, agregando ceros a la izquierda o recortando los �ltimos caracteres
	 * @param str Cadena
	 * @param newlen Nuevo largo
	 * @return Cadena ajustada
	 */
	...
	/**
	 * �ltimos caracteres de la cadena
	 * @param str Cadena
	 * @param len Cantidad de caracteres
	 * @return Cadena recortada
	 */
	...
	/**
	 * Obtener una versi�n padeada a la derecha del array pasado 
	 * @param in Array original
	 * @param newlen Nueva longitud en bytes
	 * @param car Caracter de padeo
	 * @return Versi�n padeada del array de origen
	 */
	...
	public static byte[] padRight(byte[] in, int newlen, int car)
	{
		...
		// El nuevo largo en m�s corto, copio hasta donde entre
		else
		{
			for(i = 0; i < newlen; ++i)
			{
	...
	/**
	 * Comprobar si el array de bytes representa una cadena vac�a
