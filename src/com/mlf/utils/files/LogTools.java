...
/**
 * Clase sencilla para el manejo de logs. Ofrece enviar log a la terminal y a un archivo si se ha indicado una ruta v�lida
 * Tiene m�todos para logear en varios niveles: informaci�n (log_info), advertencia (log_war) y error (log_err). Se le puede
 * dar un nivel de log, incluso apagado y crea dos archivos uno actual y uno anterior. El tama�o del log tambi�n puede ser establecido. 
 * @author Mario Foos
 */
public class LogTools
{
	 ...
	 * que solo se logean los errores. El tama�o de log por defecto se deja en 5MB
	 ...
	 * Level.ALL: Todo
	 * Level.INFO: Hasta nivel de informaci�n
	...
	/**
	 * Constructor. El tama�o de log por defecto se deja en 5MB
	 * @param logFile Ruta completa del archivo de log
	 * @param logLevel Nivel de log
	 * Level.ALL: Todo
	 * Level.INFO: Hasta nivel de informaci�n
	 ...
	 * Level.OFF: Desactivar el log
	 * @param logSize Tama�o del log
	 * @param lineSize Tama�o de la l�nea del log
	 */
	...
	/**
	 * Establecer el tama�o del archivo de log m�ximo (al superarse se guarda como viejo y se empieza con otro los)
	 * @param logSize Tama�o en bytes del log (m�nimo permitido 1kb)
	 */
	...
	/**
	 * Obtener el tama�o m�ximo en bytes del archivo de log
	 * @return Tama�o m�ximo del log
	 */
	...
	/**
	 * Establecer la m�xima longitud de l�nes del log
	 * @param maxLineLen Establecer la m�xima longitus de l�nea del log
	 */
	public void setMaxLineLen(int maxLineLen)
	{
	...
	/**
	 * Escribir en el log una cadena en la categor�a de informaci�n
	...
	/**
	 * Escribir en el log una cadena en la categor�a de advertencia
	 * @param str Cadena a logear
	 */
	...
	/**
	 * Escribir en el log una cadena en la categor�a de error
	 * @param str Cadena a logear
	 */
